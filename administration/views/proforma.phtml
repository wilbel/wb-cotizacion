            ...
            <div class="card-body">
                <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST" name="formulario">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-md-2 col-xs-12">
                    ...
                    <div class="alert alert-info" role="alert">
                        <?php echo ('Si desea cambiar el valor del IVA , vaya a <a href="admin.php?page=wrpro_menu_configuracion">Configuraciones</a>. Valor actual del IVA:' . ($valor_iva * 100)) . '%'; ?>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <table id="tabla" class="table-responsive table table-striped table-bordered table-condensed table-hover">
                        <thead style="background-color:#1290C6; color:white; font-size:14px;">
