...
<body>
    ...
    <header>
        <hr style="border:2px solid #bcd9ff">
    </header>
    ...
    <div style="position:relative;display:flex;margin-bottom:0px;padding-bottom:0px">
        ...
        <div class="col-2" style="width:40%;text-align: center;top:0px;position:relative;">
            <h3 style="margin-top:0px;color:#004aad"><?= $titulo; ?></h3>
            <table style="width:100%" cellspacing="0" cellpadding="2">
                <tr>
            ...
            <table style="width:100%" cellspacing="0" cellpadding="2">
                ...
                <tr>
                    <td style="background: #D6D6D6;"><label for="">Sitio Web:</label></td>
                    <td > <a href="<?= $site_web; ?>"><?= $site_web; ?></a>  </td>
                </tr>
